/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/slack-book-gateway/src/worker-configuration.d.ts --config workers/slack-book-gateway/wrangler.jsonc` (hash: b21f58cfa8dd565554a7794bcd23a8c0)
...
interface __BaseEnv_Env {
	...
	BOOK_PURCHASE_REQUESTS: DurableObjectNamespace<import("./index").BookPurchaseRequestState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "BookPurchaseRequestState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOOK_REQUEST_CHANNEL_ID" | "GITHUB_OWNER" | "GITHUB_REPO">> {}
}
