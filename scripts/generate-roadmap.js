...
5. **書籍の紹介方法**:
    *   書籍を読むことを学習の中心に据えてください。「参考書籍」という扱いではなく、**「この本を読むこと」自体をタスクとして提示**してください。
...
8. **「タスク」セクションや「読書感想文テンプレート」は不要です。** 純粋なロードマップとアドバイスのみを出力してください。
...
### 1. 📖 [{書籍名}](https://www.amazon.co.jp/s?k={書籍名}) を読む
*   **推奨理由**: {理由}
*   **チームメンバーの声**:
    > {引用}
    (※関連する感想文がある場合のみ記述)
...
### 2. 📝 {社内ドキュメント名} を確認する
*   **推奨理由**: {理由}
*   **リンク**: [{ドキュメント名}](https://github.com/Saitekiinc-com/saiteki-study-doc/blob/main/docs/...)
