...
この手順で作成する GitHub Issue は、書籍購入補助を使うための入口にもなります。
AIの推薦は参考なので、推薦以外の書籍を購入しても問題ありません。
購入補助を受ける場合の全体手順は [書籍購入補助の流れ](./purchase_flow) を確認してください。

## Step 1: GitHubの申請ページを開く
...
購入補助を受ける場合は、購入する本を決めた後、作成した Issue 上で手続きを進めます。
...
領収書添付や読了後の書籍レポート作成までの詳しい流れは、[書籍購入補助の流れ](./purchase_flow) を確認してください。
